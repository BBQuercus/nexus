...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-surface-0 border border-border shadow-2xl shadow-black/30 transition ease-in-out data-[state=closed]:duration-200 data-[state=open]:duration-300 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        {...props}
      >
        <SheetPrimitive.Close className="absolute right-4 top-4 rounded-sm text-text-tertiary opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none cursor-pointer">
          <X className="h-4 w-4" />
