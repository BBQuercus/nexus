...
export default function CommandPalette() {
  ...
  const actions: CommandAction[] = useMemo(() => [
    ...
    { id: 'focus-input', label: 'Focus Chat Input', icon: <MessageSquare size={13} />, shortcut: '/', category: 'Actions', handler: () => { document.querySelector('textarea')?.focus(); } },
    { id: 'toggle-panel', label: 'Toggle Right Panel', category: 'Navigation', handler: () => setRightPanelOpen(!rightPanelOpen) },
    { id: 'view-terminal', label: 'Show Terminal', icon: <Terminal size={13} />, shortcut: '1', category: 'Navigation', handler: () => { setRightPanelOpen(true); setRightPanelTab('terminal'); } },
    { id: 'view-files', label: 'Show Files', icon: <FolderOpen size={13} />, shortcut: '2', category: 'Navigation', handler: () => { setRightPanelOpen(true); setRightPanelTab('files'); } },
    { id: 'view-preview', label: 'Show Preview', icon: <Eye size={13} />, shortcut: '3', category: 'Navigation', handler: () => { setRightPanelOpen(true); setRightPanelTab('preview'); } },
    { id: 'view-artifacts', label: 'Show Artifacts', icon: <Layers size={13} />, shortcut: '4', category: 'Navigation', handler: () => { setRightPanelOpen(true); setRightPanelTab('artifacts'); } },
