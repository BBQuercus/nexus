...
> Internal data analysis tool. "Drop an Excel, get charts and a PowerPoint." Handful of users now, may go external. Must beat CompanyGPT on reliability, speed, and UX.

---

## Phase 1 — Reliability & Trust Foundation

_Users won't trust a tool that breaks. CompanyGPT's #1 complaint is "often down / having issues." We fix this first._
...
- [ ] **Cost tracking** — already have `usage_logs` table. Surface it: per-user monthly cost with visual budget bar (like CompanyGPT but better)
